      ...
      <View style={{ backgroundColor: 'white', borderWidth: 1 }}>
        <View>
          ...
          >
            ...
            <View style={{ flexDirection: 'row' }}>
              <Text style={{ padding: 15 }}>Hi</Text>
              <Image
                source={{
                  uri: 'https://cdn.shortpixel.ai/client/q_lossless,ret_img/https://www.cry.org/wp-content/uploads/2020/07/story-main-3.jpg',
                }}
                style={{
                  width: 50,
                  height: 50,
...
//           <TextInput title='Name' placeholder='Enter Company ' />
//           <Text>Role</Text>
//           <View
//             style={{
//               flex: 1,
...
//           <TextInput title='Name' placeholder='Info Field' />
//           <Text>Option Name</Text>
//           <TextInput title='Name' placeholder='Option Field' />
//           <Button title='Submit' />
//         </View>
//       </View>
//     </ScrollView>
      ...
      <ScrollView>
        ...
        <View style={{ backgroundColor: 'white' }}>
          ...
          >
            ...
            <Button title='Selling' style={{ padding: 20 }} />
          </View>
          <View
            style={{ justifyContent: 'space-between', flexDirection: 'row' }}
          >
            <Text style={{ fontSize: 20 }}>My Deals</Text>
            <Text
              style={{
          ...
          >
            ...
            >
              <View style={{ flexDirection: 'row' }}>
                <Text style={{ padding: 15 }}>172345</Text>
              </View>
              <View style={{ flexDirection: 'row', padding: 15 }}>
                <Button title='Live' color='green' />
                <Text style={{ padding: 15 }}> 🔴 </Text>
              </View>
            </View>
            <View>
              <Text style={{ padding: 15 }}>Date : {currDate}</Text>
            </View>
            <View
              style={{
                flexDirection: 'row',
            ...
            >
              <View>
                <Text>Electric Spares</Text>
                <Text style={{ width: 200 }}>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Consequatur atque cumque laboriosam ipsam reiciendis pariatur
                  optio laborum obcaecati debitis voluptates?
                </Text>
              </View>
              <View style={{ flexDirection: 'row' }}>
                <Image
                  source={{
                    uri: 'https://www.processindustryforum.com/wp-content/uploads/2014/03/Centrifugal-pumps.jpg',
                  }}
            ...
            <View>
              <Text style={{ padding: 15 }}>Offer Deadline : {currDate}</Text>
            </View>
            <View
              style={{
                flexDirection: 'row',
            ...
            >
              <Button title='Chat with Deal Manager Ⓜ️' />
            </View>
          </View>
        </View>
        {/* Another Box*/}
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          ...
          >
            ...
            >
              <View style={{ flexDirection: 'row' }}>
                <Text style={{ padding: 15 }}>147568</Text>
              </View>
              <View style={{ flexDirection: 'row', padding: 15 }}>
                <Button title='Live' color='green' />
                <Text style={{ padding: 15 }}> 🔴 </Text>
            ...
            >
              <View>
                ...
                <Text style={{ width: 200 }}>
                  ...
                  velit assumenda repellat eligendi consequuntur magni
                  perferendis doloremque perspiciatis dignissimos dolor dolore
                  molestias officiis illo repellendus, non exercitationem
                  dolorem, unde quas.
                </Text>
              </View>
              <View style={{ flexDirection: 'row' }}>
                <Image
                  source={{
                    uri: 'https://img3.exportersindia.com/product_images/bc-full/2018/7/5358397/condenser-heat-exchangers-1531807934-4109470.png',
                  }}
                  style={{ width: 100, height: 200, resizeMode: 'contain' }}
                />
              </View>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          ...
          >
            ...
            >
              ...
              <View style={{ flexDirection: 'row', padding: 15 }}>
                <Button title='Closed' color='grey' />
                {/* <Text style={{ padding: 15 }}> 🔴 </Text> */}
              </View>
            </View>
            <View>
            ...
            >
              <Button title='Chat with Deal Manager Ⓜ️' color='grey' />
            </View>
          </View>
        </ScrollView>
        {/* End of box */}
